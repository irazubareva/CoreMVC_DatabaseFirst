...
using CoreMVC_DatabaseFirst.Data;
using CoreMVC_DatabaseFirst.Models;

namespace CoreMVC_DatabaseFirst.Controllers
{
    // команда для генерации DbContext из БД
    // Scaffold-DbContext "Server=.\SQLExpress;Database=pubs;Trusted_Connection=True;TrustServerCertificate=True" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models -ContextDir Data -Tables Authors -DataAnnotations
